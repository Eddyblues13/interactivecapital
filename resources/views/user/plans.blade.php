    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="pricing-card">
                ...
                <div class="usd-amount">USD {{ number_format($plan->price, 0) }}</div>
                <ul class="feature-list">
                    <li class="feature-item">
                        <span class="feature-text">{{ $plan->pairs }}+ Pairs</span>
                        <span class="check-icon"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                                viewBox="0 -960 960 960" width="24px" fill="#00ff9d">
                                <path
