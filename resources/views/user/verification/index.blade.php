    ...
    <div class="row g-4 d-flex justify-content-center">
        <div class="col-md-8">
            ...
            <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                ...
                <div class="text-header"><span class="text-info">Email Verification</span> Skipped</div>
            </div>
            ...
            <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                ...
                <div class="text-header"><span class="text-info">Identity Verification</span> Pending</div>
            </div>
            ...
            <div class="settings-card rounded-3 p-3 mb-3 d-flex align-items-center">
                ...
                <div class="text-header"><span class="text-info">Address Verification</span> Pending</div>
            </div>
        </div>
    </div>
</div>
